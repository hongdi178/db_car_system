...
<head>
    ...
    <title>车辆运货预约</title>
    <script type="text/javascript" src="/Public/html/js/flexible.js"></script>
    <link rel="stylesheet" type="text/css" href="/Public/html/css/index.css">
    <link rel="stylesheet" type="text/css" href="/Public/html/css/jquery-weui.min.css">
    <link rel="stylesheet" type="text/css" href="/Public/html/css/weui.min.css">
...
<div id="main">
    ...
    <div id="top">
        <img src="/Public/html/images/banner.png" class="topImg">
    ...
    <div class="list" style="height:6.5rem">
        ...
        <div id="footer">
            <a href="<?php echo U('index/index');?>" class="on">
                <img src="/Public/html/images/paiduichaxun2.png" alt="">
                <p>排队查询</p>
            </a>
            <a href="<?php echo U('Order/index');?>">
                <img src="/Public/html/images/yuyue.png" alt="">
                <p>预约装车</p>
            </a>
            <a href="<?php echo U('my/page');?>">
                <img src="/Public/html/images/gerenzhongxin.png" alt="">
                <p>个人中心</p>
            </a>
        </div>
    </div>
</body>
<script type="text/javascript" src="/Public/html/js/vue.min.js"></script>
<script src="/Public/html/js/jquery.min weui.js"></script>
<script src="/Public/html/js/jquery-weui.min.js"></script>
