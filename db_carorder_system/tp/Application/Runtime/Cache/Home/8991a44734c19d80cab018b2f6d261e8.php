...
<body>
<div align="center">
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><p id="name" hidden><?php echo ($vo["id"]); ?></p>
        <p>角色名：<?php echo ($vo["name"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>

</div>
<div align="center">
    <input type="checkbox"  value="1" id="user" /> 用户管理
    <input type="checkbox" value="1" id="password">修改密码
    <input type="checkbox"  value="1" id="operate"/> 操作日志
</div>
<div align="center">
    <input type="checkbox"  value="1" id="admin"/> 管理员管理
    <input type="checkbox"  value="1" id="oil"/> 油品类型管理
    <input type="checkbox"  value="1" id="list"/> 车辆队列管理
</div>
<div align="center">
    <input type="checkbox"  value="1" id="power"/> 权限管理
    <input type="checkbox"  value="1" id="announce"/> 公告内容管理
</div>
<div align="center">
    <button id="submit">确定修改</button>
</div>
</body>
<script src="/Public/jquery-3.3.1/jquery-3.3.1.js"></script>
<script src="/Public/js/dialog.js"></script>
<script src="/Public/dialog/layer.js"></script>
<script src="/Public/js/power/update.js"></script>
<script src="/Public/layui-v2.2.5/layui/layui.js" charset="utf-8"></script>
</html>