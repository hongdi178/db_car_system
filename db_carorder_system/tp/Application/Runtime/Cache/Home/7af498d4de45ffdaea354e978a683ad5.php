...
<body>
<div align="center">
        <div><input  name="id" value="<?php echo ($attr["id"]); ?>"  type="hidden"/></div>
        <div><input type="hidden" name="head_img" value="<?php echo ($attr["head_img"]); ?>" disabled/></div>
        <div><input type="hidden" name="nickname" value="<?php echo ($attr["nickname"]); ?>" disabled/></div>
        <div>真实姓名：<input type="text" name="name" value="<?php echo ($attr["name"]); ?>"/></div>
        <div>手机号码：<input type="text" name="phone" value="<?php echo ($attr["phone"]); ?>"/></div>
        <div>车辆车牌：<input type="text" name="plate_number" value="<?php echo ($attr["plate_number"]); ?>"/></div>
        <div>隶属公司：<input type="text" name="company" value="<?php echo ($attr["company"]); ?>"/></div>
