...
<div align="center">
    <form >
        <div align="center">
            ...
            <BR>
            <span style="display:inline-block;width:150px;text-align:right;">再输入一次密码：</span>
    ...
    <a href="<?php echo U('Home/admin/manage');?>">返回</a>
</div>
</body>
<script src="/Public/jquery-3.3.1/jquery-3.3.1.js"></script>
<script src="/Public/layui-v2.2.5/layui/layui.js" charset="utf-8"></script>
<script src="/Public/js/dialog.js"></script>
<script src="/Public/dialog/layer.js"></script>
<script src="/Public/js/admin/add.js"></script>
