$('#submit').click(function(){
    ...
    var action='';
     if(!(password||operate||admin||oil||list||power||announce)){
        ...
        var url = "../power/updateAction";
        console.log(action);
        var data = {'id':id,'name':name,'user':user,'operate':operate,'admin':admin,'oil':oil,'list':list,'power':power,'announce':announce,'action':action};
        // 执行异步请求  $.post
