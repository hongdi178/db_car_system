...
$(".subBtn").click(function () {
    ...
    var plateNumberFirst=$('select#first').find("option:selected").text();
    var plateNumberSecond=$('select#second').find("option:selected").text();
    if(!name) {
        ...
        var data = {'name':name,'phone':phone,'oilFather':oilFather,'oil':oil,'car_plate_number':plateNumber,'company':company,'first':plateNumberFirst,'second':plateNumberSecond};
        // 执行异步请求  $.post
